...
class Game():
    ...
    def load_game_data(self):
        ...
        # Images
        self.spritesheet = Spritesheet(os.path.join(img_dir, SPRITESHEET_PLAYER_IDLE))
        self.spritesheet_run = Spritesheet(os.path.join(img_dir, SPRITESHEET_PLAYER_RUN))
        self.spritesheet_jump = Spritesheet(os.path.join(img_dir, SPRITESHEET_PLAYER_JUMP))
